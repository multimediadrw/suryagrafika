        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-sky-200 text-sm leading-relaxed mb-4">
              Percetakan profesional dengan kualitas terbaik. Kami melayani berbagai kebutuhan cetak Anda dengan hasil yang memuaskan dan harga yang terjangkau.
            </p>
            <div className="flex space-x-4">
              <a href="https://wa.me/6281234567890" target="_blank" rel="noopener noreferrer"
                className="bg-sky-700 hover:bg-sky-600 p-2 rounded-full transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-sky-200">
              <li className="flex items-start space-x-2">
                ...
                <span>Jl. Percetakan No. 1, Kota Anda</span>
              </li>
